            ...
            firebaseFirestore.collection("Pending Orders")
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        String custName, custNumber, orderAmtPaid, custImage, orderTimestamp, custID, orderStatus, docID, custOrderID, payment,tableNo;
                        ...
                        for (DocumentSnapshot documentSnapshot : task.getResult()) {
                            ...
                            tableNo = documentSnapshot.getString("tableNumber");
                            ...
                            orderArrayList.add(new Order(custName,custNumber,custID,custImage,orderAmtPaid,orderTimestamp,orderStatus,foodQtyList, docID, custOrderID,payment,tableNo));
