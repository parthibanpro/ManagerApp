...
public class PendingOrderAdapter extends RecyclerView.Adapter<PendingOrderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.paymentTxt.setText(""+mOrderList.get(position).getPayment());
        holder.tableNo.setText("Table No: "+mOrderList.get(position).getTableNo());
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private TextView custName, custNumber, orderDate, orderTime, orderPrice, orderNo,paymentTxt,tableNo;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            this.paymentTxt = itemView.findViewById(R.id.payment);
            this.tableNo = itemView.findViewById(R.id.table);
